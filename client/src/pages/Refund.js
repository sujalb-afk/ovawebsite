  ...
  return (
    <div className="legal-page-wrap">
      <SEO
        ...
        description="OVA™'s policy on returns and refunds for purchases and donations."
        canonical="/refund"
      ...
      <section className="about-hero">
        ...
        <div className="container about-hero-container">
          <div className="about-hero-content">
            <h1 className="about-hero-title">Return and Refund Policy</h1>
            <p className="about-hero-subtext">Last updated: December 05, 2024</p>
          </div>
        </div>
      </section>
